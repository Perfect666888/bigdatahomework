...
public class AvgUtils {
    ...
    public static void sortAvg(ArrayList<String> classAvgArr) throws Exception {
        ...
        //添加名次
        Day7_11.util.Utils.AddRank(classAvgArr);
        ...
        Day7_11.util.Utils.ArrToFile(classAvgArr, fileName);
    ...
    public static void sortAvgByArt(ArrayList<String> classAvgArr) throws Exception {
        ...
        //添加名次
        Day7_11.util.Utils.AddRank(lkAvgArr);
        Day7_11.util.Utils.AddRank(wkAvgArr);
        ...
        Day7_11.util.Utils.ArrToFile(lkAvgArr, fileName);

        //创建路径名字
        String fileName2 = "F:\\BigData\\IDEA\\bigdatahomework\\src\\Day7_11\\Result\\文科班级平均分排名.txt";
        Day7_11.util.Utils.ArrToFile(wkAvgArr, fileName2);
    ...
    public static void AvgByCno() throws Exception {
        ...
        Day7_11.util.Utils.AddRank(avgArr);
